...
- On Listening / Dinleme Üstüne (/english/on-listening.html + /turkce/dinleme-ustune.html, fikir yazısı — rapor DEĞİL, Okuma Halkası #7 ürünü): dinleme üstüne bağımsız deneme; --ses (#c9a06a) sıcak amber; v1.2 · 16 Tem 2026 (O240 ilk yayım EN+TR; v1.1 görsel, v1.2 dinlenmek pasajı düzeltildi). hreflang: tr + en + x-default→EN (DE/FR/ES/ZH gelince genişler). Sonda tek satır vesile: Faith Lawrence "The listening gift" (Aeon 2025) linki — özet YOK (O239 kararı: bağımsız fikir yazısı, reading-response değil). Rilke alıntısı EN'de Norton 1945 birebir, TR'de bu yazı için çevrildi (iki muhur footer'da künye). Duvar girişleri en üstte: EN "Listening is dead; what remains is hearing." / TR "Dinleme öldü, geriye işitme kaldı." Görsel: Tasvir T62 hero SVG iki sayfada canlı (masaüstü+mobil). KCWorks akademik DOI (O258, 17 Tem 2026): EN 10.17613/0e9xf-9sa16 · TR 10.17613/p8j6r-qaq65 (CC BY 4.0; footer'da DOI künyesi, sürüm v1.2 korundu).
