...
- On Listening (/english/on-listening.html, fikir yazısı — rapor DEĞİL, Okuma Halkası #7 ürünü): dinleme üstüne bağımsız deneme; --ses (#c9a06a) sıcak amber; v1.0 · 16 Tem 2026 (O240). Şimdilik YALNIZ EN (hreflang en + x-default kendine; TR/diğer diller gelince genişler). Sonda tek satır vesile: Faith Lawrence "The listening gift" (Aeon 2025) linki — özet YOK (O239 kararı: bağımsız fikir yazısı, reading-response değil). Rilke alıntısı Norton 1945 birebir (muhur footer'da künye). EN index duvarında en üstte: "Listening is dead; what remains is hearing."
